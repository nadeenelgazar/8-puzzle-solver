...
public class A1euclidean {
    int x = 0 ;
    public boolean A11 (int [][] initial,int [][] goal){

        PriorityQueue<node> frontier = new PriorityQueue<>(new nodeComparetorEuclidean());
    ...
    public static void main(String[] args) {
        ...
        A1euclidean obj = new A1euclidean();
