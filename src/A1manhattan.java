...
public class A1manhattan {
    int x = 0 ;
    public boolean A11 (int [][] initial,int [][] goal){

        PriorityQueue<node> frontier = new PriorityQueue<>(new nodecomparetormanhattan());
    ...
    public static void main(String[] args) {
        ...
        A1manhattan obj = new A1manhattan();

        long start = System.currentTimeMillis();
        obj.A11(initial,goal);
